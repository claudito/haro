...
<div class="panel panel-default">
	...
	<table  id="consulta" class="table table-bordered table-condensed">
		...
		<a href="ordenes-servicio-detalle?codigo=<?php echo $value['numero'];?>" class="btn btn-primary btn-xs"><i class="glyphicon glyphicon-list"></i></a>
		...
		<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#dataDelete" data-id="<?php echo $value['numero']; ?>"><i class="glyphicon glyphicon-trash" title="Eliminar"></i></button>
		<a href="<?php echo PATH; ?>docs/pdf/reporte/os?id=<?php echo $value['numero']; ?>" class="btn btn-warning btn-xs" target="_blank"><i class="glyphicon glyphicon-print" title="Imprimir"></i></a>
