...
<input type="text" name="codigo2" id=""  class="form-control" maxlength="20" 
...
<input type="text" name="descripcion" id=""  class="form-control" maxlength="100" 
 onchange="Mayusculas(this)" value="<?php echo $objeto->consulta($id,'descripcion'); ?>">
</div>

<div class="form-group">
<label>DESCRIPCIÓN 2</label>
<input type="text" name="descripcion2" id=""  class="form-control" maxlength="100" 
