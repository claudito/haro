...
<div class="panel panel-info">
	...
	<table  id="consulta" class="table table-bordered table-condensed">
		...
		<td style="text-align: center;">
		 ...
		 <a data-id="<?php echo $value['id'];?>" id=""  class="btn btn-upload btn-xs btn-primary" title="Carga"><i class="fa fa-upload"></i></a>
		 <button type="button" class="btn btn-listar-files btn btn-success btn-xs" data-toggle="modal" data-target="#dataInfo" data-id="<?php echo $value['id']; ?>" title="Vista"><i class="glyphicon glyphicon-eye-open"></i></button>
     <a data-id="<?php echo $value['id'];?>" id=""  class="btn btn-edit btn-xs btn-info" title="Actualizar"><i class="glyphicon glyphicon-edit"></i></a>
		<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#dataDelete" data-id="<?php echo $value['id']; ?>" title="Eliminar"><i class="glyphicon glyphicon-trash"></i></button>
		</td>
		</tr>
		<?php endforeach ?>
		</tbody>
