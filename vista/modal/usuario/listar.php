...
<div class="panel panel-default">
	...
	<table  id="consulta" class="table table-bordered table-condensed">
      ...
      <a data-id="<?php echo $value['id'];?>" id=""  class="btn btn-firma btn-sm btn-default" title="Cargar Firma"><i class="fa fa-pencil"></i></a>
      <a data-id="<?php echo $value['id'];?>" id=""  class="btn btn-usuario-tipo btn-sm btn-success" title="Permisos tipo usuario"><i class="fa fa-user"></i></a>
		  <a data-id="<?php echo $value['id'];?>" id=""  class="btn btn-permisos btn-sm btn-warning" title="Habilitar permisos de Usuario"><i class="glyphicon glyphicon-lock"></i></a>
		 <a data-id="<?php echo $value['id'];?>" id=""  class="btn btn-edit btn-sm btn-info" title="Actualizar"><i class="glyphicon glyphicon-edit"></i></a>
