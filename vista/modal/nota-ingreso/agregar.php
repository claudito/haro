...
<input type="hidden" name="tipo" id="" class="form-control" value="NI">
...
<select name="tipo_transaccion" required="" id="" class="form-control">
<option value="">[Seleccionar]</option>
<?php
$transaccion_tipo = new Transaccion_tipo();
foreach ($transaccion_tipo->lista_nav() as $key => $value): ?>
...
<input type="text" name="num_ref" id=""   class="form-control" maxlength="100" onchange="Mayusculas(this)">
</div>
</div>
...
<input type="number" step="any" name="doc_oc" id="" class="form-control"  min="0.00">
</div>
</div>
</div>
