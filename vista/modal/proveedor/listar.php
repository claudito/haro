...
<div class="panel panel-default">
	...
	<table  id="consulta" class="table table-bordered table-condensed">
		...
		<td><?php echo $value['cuenta_soles']; ?></td>
		<td><?php echo $value['cuenta_dolares']; ?></td>
		...
		<td style="text-align: center;">
		 <button data-id="<?php echo $value['id'];?>" id=""  class="btn btn-edit btn-xs btn-info" title="Actualizar"><i class="glyphicon glyphicon-edit" ></i></button>
