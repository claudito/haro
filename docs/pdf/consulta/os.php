...
$firma_1 = $objeto->estado_firma('OS',$_GET['id'],'1','estado');
$firma_1 = (!empty($firma_1)) ? $firma_1 : 0 ;

$firma_2 = $objeto->estado_firma('OS',$_GET['id'],'2','estado');
$firma_2 = (!empty($firma_2)) ? $firma_2 : 0 ;

$firma_3 = $objeto->estado_firma('OS',$_GET['id'],'3','estado');
...
<tr>
<td class="name-documento">N° ORDEN DE SERVICIO</td>
...
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'proveedor','OS'); ?></td>
<td class="cabecera-td">FECHA EMISIÓN</td>
<td class="cabecera-td"><?php echo date_format(date_create($comovc->consulta($_GET['id'],'fecha_inicio','OS')),'d/m/Y'); ?></td>
</tr>
<tr>
<td class="cabecera-td">RUC</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'ruc','OS'); ?></td>
<td class="cabecera-td">FECHA DE ENTREGA</td>
<td class="cabecera-td"><?php echo date_format(date_create($comovc->consulta($_GET['id'],'fecha_fin','OS')),'d/m/Y'); ?></td>
</tr>
<tr>
<td class="cabecera-td">DIRECCIÓN</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'direccion1','OS'); ?></td>
<td class="cabecera-td">COMPRADOR</td>
<td class="cabecera-td">GUSTAVO MONTERO</td>
</tr>
<tr>
<td class="cabecera-td">CONTACTO</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'contacto','OS'); ?></td>
<td class="cabecera-td">REQUISCIÓN</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'requerimiento','OS'); ?></td>
</tr>
<tr>
<td class="cabecera-td">EMAIL</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'correo','OS'); ?></td>
<td class="cabecera-td">COTIZACIÓN</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'cotizacion','OS'); ?></td>
</tr>
<tr>
<td class="cabecera-td">TELÉFONO</td>
<td class="cabecera-td"><?php echo $comovc->consulta($_GET['id'],'telefono','OS'); ?></td>
...
<?php 
$total = 0;
foreach ($comovd->lista($_GET['id'],'OS') as $key => $value): ?>
<tr>
...
<td class="operacion-td left"><?php echo $comovc->consulta($_GET['id'],'condiciones_pago','OS'); ?></td>
...
<td class="operacion-td left"><?php echo $comovc->consulta($_GET['id'],'lugar_entrega','OS'); ?></td>
...
<td class="operacion-td left"><?php echo $comovc->consulta($_GET['id'],'modo_entrega','OS'); ?></td>
