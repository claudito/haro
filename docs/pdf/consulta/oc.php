...
$firma_1 = $objeto->estado_firma('OC',$_GET['id'],'1','estado');
$firma_1 = (!empty($firma_1)) ? $firma_1 : 0 ;

$firma_2 = $objeto->estado_firma('OC',$_GET['id'],'2','estado');
$firma_2 = (!empty($firma_2)) ? $firma_2 : 0 ;

$firma_3 = $objeto->estado_firma('OC',$_GET['id'],'3','estado');
...
<td class="operacion-td left"><?php echo $comovc->consulta($_GET['id'],'comentario','OC'); ?></td>
