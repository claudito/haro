...
$firma_1 = $objeto->estado_firma('RS',$_GET['id'],'1','estado');
$firma_1 = (!empty($firma_1)) ? $firma_1 : 0 ;

$firma_2 = $objeto->estado_firma('RS',$_GET['id'],'2','estado');
$firma_2 = (!empty($firma_2)) ? $firma_2 : 0 ;

$firma_3 = $objeto->estado_firma('RS',$_GET['id'],'3','estado');
...
<head>
	<meta charset="UTF-8">
	<title>Requerimiento de Servicio <?php echo str_pad($_GET['id'],10,'0',STR_PAD_LEFT) ?></title>
...
<h2 class="center">REQUERIMIENTO DE SERVICIO N° <?php echo str_pad($_GET['id'],10,'0',STR_PAD_LEFT) ?></h2>
...
<td class="detalle-td center"><?php echo ($value['estado']=='P') ? "PENDIENTE" : "ATENDIDO" ; ?> </td>
</tr>
<?php endforeach ?>
<tr>
