...
if (isset($_POST['cantidad']) AND isset($_POST['numero_rq']) AND isset($_POST['id_detalle']) AND isset($_POST['idnumero']) )
{
...
$numero_rq         =  $_POST['numero_rq'];//numero del requerimiento 
