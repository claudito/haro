...
if (isset($_POST['id_usuario']) AND isset($_POST['fecha_inicio']) AND isset($_POST['fecha_fin']) AND isset($_POST['centro_costo']) AND isset($_POST['area']) AND isset($_POST['tipo']) AND isset($_POST['prioridad']) AND isset($_POST['comentario'])) 
{  
...
if (strlen($id_usuario)>0 AND strlen($fecha_inicio)>0 AND strlen($fecha_fin)>0 AND strlen($centro_costo)>0 AND strlen($area)>0 AND strlen($tipo)>0 AND strlen($prioridad)>0) 
{
  
$objeto      =  new Requisc($numero,$id_usuario,$fecha_inicio,$fecha_fin,$centro_costo,$area,$tipo,'',$prioridad,$comentario);
