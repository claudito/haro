...
$objeto      =  new Comovc($numero,$id_usuario,$id_proveedor,$fecha_inicio,$fecha_fin,$comentario,$centro_costo,$area,$tipo,$estado,$prioridad,$cotizacion,$condiciones_pago,$lugar_entrega,$modo_entrega);
