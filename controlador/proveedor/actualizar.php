...
if (isset($_POST['id']) AND isset($_POST['codigo']) AND isset($_POST['contacto']) AND isset($_POST['cuenta_soles']) AND isset($_POST['cuenta_dolares']) AND isset($_POST['razon_social']) AND isset($_POST['ruc']) AND isset($_POST['dni']) AND isset($_POST['direccion1']) AND isset($_POST['direccion2']) AND isset($_POST['telefono']) AND isset($_POST['correo']) AND isset($_POST['comentario'])) 
{
	...
	if (strlen($id)>0 AND strlen($codigo)>0 AND strlen($contacto)>0 AND strlen($cuenta_soles)>0 AND strlen($cuenta_dolares)>0 AND strlen($razon_social)>0 AND strlen($ruc)>0 AND strlen($dni)>0 AND strlen($direccion1)>0 AND strlen($direccion2)>0 AND strlen($telefono)>0 AND strlen($correo)>0 AND strlen($comentario)>0 ) 
	{
