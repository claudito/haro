...
#actualizar estado rq compra - servicio
Requisc::actualizar_estado($tipo,$numero);

#actualizar pdf
 //Requisd::actualizar_estado($tipo,$numero);
...
Requisc::actualizar_estado_oc($tipo,$numero);
