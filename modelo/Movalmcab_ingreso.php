...
public function agregar()
{
   try {
    ...
    {
     $query     = "INSERT INTO movalmcab(numero,alm,tran,doc_ref,num_ref,id_usuario,id_proveedor,fecha_inicio,fecha_fin,comentario,centro_costo,area,tipo) 
     VALUES (:numero,:alm,:tran,:doc_ref,:num_ref,:id_usuario,:id_proveedor,:fecha_inicio,:fecha_fin,:comentario,:centro_costo,:area,:tipo)";
...
public function actualizar($id)
{
   ...
   try {
    $modelo    = new Conexion();
    $conexion  = $modelo->get_conexion();
    $query     = "UPDATE  movalmcab  SET  tran=:tran,doc_ref=:doc_ref,num_ref=:num_ref,id_proveedor=:id_proveedor,fecha_inicio=:fecha_inicio,fecha_fin=:fecha_fin,comentario=:comentario,centro_costo=:centro_costo,area=:area,estado=:estado WHERE  numero=:id AND tipo=:tipo";
