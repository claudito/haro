var objeto =  "ordenes-compra-detalle";
...
$("#numero_rq").change(function () {
$("#numero_rq option:selected").each(function () {
elegido=$(this).val();
$.post("../ajax/select/detalle_rq.php", { elegido: elegido }, function(data){
